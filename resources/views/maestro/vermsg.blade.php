            ...
            <!-- DIRECT CHAT WARNING -->
                        <div class="card card-warning direct-chat direct-chat-warning">
                            ...
                            <div  class="direct-chat-messages">
                              ...
                              <div v-if="recibe!=msg.de" class="direct-chat-msg">
                                <div class="direct-chat-infos clearfix">
                                  <span class="direct-chat-name float-left">@{{alumno.nombre}}</span>
                                </div>
                                <!-- /.direct-chat-infos -->
                                <img class="direct-chat-img" src="{{URL::to('/')}}/{{$alumno->foto}}" alt="Message User Image">
                                <!-- /.direct-chat-img -->
                          ...
                          <div class="card-footer">
                            <form action="{{action('Maestro\MaestroController@send')}}" method="post">
                              <div class="input-group">
                              {{csrf_field()}}
                                <input type="text" name="mensaje" placeholder="Type Message ..." class="form-control">
  ...
  <script>
    new Vue({
      ...
      data:{
        ...
        alumno:<?php echo json_encode($alumno);?>,
